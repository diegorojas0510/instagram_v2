...
ActiveRecord::Schema[7.0].define(version: 2022_07_18_232837) do
  ...
  create_table "pot_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_pot_categories_on_category_id"
    t.index ["pot_id"], name: "index_pot_categories_on_pot_id"
  end
